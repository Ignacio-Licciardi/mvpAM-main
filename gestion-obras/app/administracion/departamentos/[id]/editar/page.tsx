...
export default function EditarDepartamentoPage() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (res.data.success) {
          ...
          setNombre(res.data.data.nombreDepartamento)
        }
      } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setSaving(true)
      await departamentosApi.update(id, { nombreDepartamento: nombre })
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Modifique los datos del departamento</p>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Actualice los datos del departamento</CardDescription>
          </CardHeader>
          <CardContent>
